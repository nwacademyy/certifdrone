  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="pt-16">
        ...
        {/* Hero */}
        <section className="bg-gradient-to-br from-violet-50 to-white py-10 sm:py-16 px-4">
          <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
                Une tarification <span className="text-violet-600">adaptée</span>{" "}
                pour vos <span className="text-violet-600">examens drone</span>
              </h1>
              <p className="text-gray-600">
                Que vous soyez futur télépilote <strong>loisir</strong> ou <strong>professionnel</strong>, nos cours et QCM drone s&apos;adaptent à vos besoins
              </p>
              <Link href="/inscription" className="inline-block mt-6 bg-violet-600 text-white font-semibold px-6 py-3 rounded-full hover:bg-violet-700 transition-colors">Inscription</Link>
            </div>
            <div className="bg-white rounded-2xl border border-violet-200 p-6 shadow-md max-w-sm w-full text-center">
              <h2 className="font-bold text-gray-800 mb-2">Profitez d&apos;un accès <span className="text-violet-600">complet</span> !</h2>
              <p className="text-sm text-gray-600 mb-4">Profitez d&apos;un accès à nos Cours, QCM, Fiches de révision et notre support en ligne à partir de <strong className="text-violet-600">29,90€</strong>.</p>
              <Link href="/formations/bapd" className="block text-center border-2 border-violet-600 text-violet-600 font-semibold py-2 rounded-full hover:bg-violet-50 transition-colors text-sm">Voir nos offres</Link>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="border-2 border-gray-200 rounded-2xl p-6 flex flex-col">
                ...
                <div className="text-4xl font-extrabold text-violet-600 mb-1">29,90€</div>
                ...
                <Link href="/formations/bapd" className="block text-center border-2 border-violet-600 text-violet-600 font-semibold py-3 rounded-full hover:bg-violet-50 transition-colors text-sm">Découvrir</Link>
              </div>
              {/* CATS */}
              <div className="bg-violet-600 rounded-2xl p-6 flex flex-col shadow-lg relative">
                ...
                <div className="text-xs font-semibold text-violet-100 uppercase mb-1">Catégorie Spécifique Europe</div>
                ...
                <p className="text-xs text-violet-100 mb-4">TVA incluse</p>
                ...
                <Link href="/formations/cats" className="block text-center bg-white text-violet-600 font-semibold py-3 rounded-full hover:bg-violet-50 transition-colors text-sm">Découvrir</Link>
              </div>
              {/* Pack formations */}
              <div className="border-2 border-green-300 rounded-2xl p-6 flex flex-col bg-green-50">
                ...
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-4xl font-extrabold text-violet-600">69,80€</span>
                </div>
                ...
                <div className="flex items-center justify-center gap-2 text-sm text-gray-600 mb-4 border-t border-green-200 pt-4">
                  <span className="font-semibold">BAPD <span className="text-violet-600">29,90€</span></span>
                  <span>+</span>
                  <span className="font-semibold">CATS <span className="text-violet-600">49,90€</span></span>
                  <span>=</span>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 p-6">
                ...
                <div className="text-xs font-semibold text-violet-600 mb-3">FORMATION + EXAMEN OFFICIEL RDW</div>
                ...
                <p className="text-xs text-violet-600 font-medium mb-4">Bénéficiez de 5 passages inclus !</p>
                ...
                <Link href="/formations/a2" className="block text-center bg-violet-600 text-white font-semibold py-3 rounded-full hover:bg-violet-700 transition-colors text-sm">Passer l&apos;examen →</Link>
              </div>
              {/* CATS exam */}
              <div className="bg-white rounded-2xl border-2 border-violet-200 p-6">
                ...
                <Link href="/formations/cats" className="block text-center bg-violet-600 text-white font-semibold py-3 rounded-full hover:bg-violet-700 transition-colors text-sm">Passer l&apos;examen →</Link>
              </div>
            </div>

            {/* Pack complet 299€ */}
            <div className="bg-violet-50 border-2 border-violet-300 rounded-2xl p-8 text-center relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-violet-600 text-white text-xs font-bold px-4 py-1 rounded-full">✦ PACK COMPLET · LE PLUS AVANTAGEUX</div>
              ...
              <div className="flex items-center justify-center gap-4 mb-2">
                ...
                <span className="text-5xl font-extrabold text-violet-600">299€</span>
              ...
              <Link href="/inscription" className="inline-block bg-violet-600 text-white font-bold px-10 py-4 rounded-full hover:bg-violet-700 transition-colors text-lg">Ajouter le pack au panier →</Link>
        ...
        <section className="py-12 px-4 bg-white border-t border-gray-100">
          <div className="max-w-3xl mx-auto border-2 border-blue-200 rounded-2xl p-8 text-center bg-blue-50">
            ...
            <div className="text-4xl font-extrabold text-violet-600 mb-1">199€ <span className="text-base font-normal text-gray-400">TTC</span></div>
            ...
            <Link href="/outils/manex" className="inline-block bg-violet-600 text-white font-bold px-8 py-3 rounded-full hover:bg-violet-700 transition-colors">Générer mon MANEX →</Link>
          </div>
        </section>
        ...
        <section className="py-10 px-4 bg-gray-50 border-t border-gray-100">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a href="tel:0430968186" className="inline-block mt-2 text-violet-600 font-bold text-lg hover:text-violet-600">📞 04 30 96 81 86</a>

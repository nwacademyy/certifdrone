  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="pt-16">
        ...
        {/* Hero */}
        <section className="bg-gradient-to-br from-violet-50 to-white py-12 sm:py-20 px-4">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">
                Préparation et{" "}
                <span className="text-violet-600">Examens Drone</span>{" "}
                en ligne – Formation, Cours &amp; QCM 2026
              </h1>
              <p className="text-gray-600 text-base sm:text-lg mb-6">
                Première plateforme avec <strong className="text-violet-600">cours complet et conformes</strong>, QCM, <strong className="text-violet-600">examens blancs</strong> &amp; <strong className="text-violet-600">fiches de révisions</strong> pour les Examens Français et européens.
              </p>
              <Link href="/inscription" className="inline-block bg-violet-600 text-white font-semibold px-8 py-3 rounded-full text-base sm:text-lg hover:bg-violet-700 transition-colors shadow-md">
                Inscription
              </Link>
            </div>
            {/* Mock QCM card */}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-2xl border-2 border-gray-200 p-6 flex flex-col">
                ...
                <div className="text-3xl font-extrabold text-violet-600 mb-1">29,90€</div>
                ...
                <Link href="/formations/bapd" className="block text-center bg-violet-600 text-white font-semibold py-3 rounded-full hover:bg-violet-700 transition-colors">Démarrer l&apos;entraînement</Link>
              </div>
              {/* CATS */}
              <div className="bg-violet-600 rounded-2xl p-6 flex flex-col relative shadow-lg">
                ...
                <div className="text-xs font-semibold text-violet-100 uppercase tracking-wider mb-1">Catégorie Spécifique Europe</div>
                ...
                <p className="text-sm text-violet-100 mb-4">TVA incluse · Accès immédiat</p>
                ...
                <Link href="/formations/cats" className="block text-center bg-white text-violet-600 font-semibold py-3 rounded-full hover:bg-violet-50 transition-colors">Démarrer l&apos;entraînement</Link>
              </div>
              {/* Pack Full */}
              <div className="bg-white rounded-2xl border-2 border-gray-200 p-6 flex flex-col relative">
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="text-3xl font-extrabold text-violet-600">69,80€</span>
                ...
                <Link href="/tarifs" className="block text-center border-2 border-violet-600 text-violet-600 font-semibold py-3 rounded-full hover:bg-violet-50 transition-colors">Voir le pack</Link>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {/* BAPD A2 exam */}
              <div className="border-2 border-gray-200 rounded-2xl p-6 hover:border-violet-300 transition-colors">
                ...
                <div className="text-sm font-semibold text-violet-600 mb-2">FORMATION + EXAMEN OFFICIEL RDW</div>
              ...
              {/* CATS exam */}
              <div className="border-2 border-violet-200 rounded-2xl p-6 bg-violet-50">
                <div className="text-sm text-gray-500 mb-1">Présentez votre diplôme</div>
            ...
            <div className="border-2 border-green-400 rounded-2xl p-6 bg-green-50 max-w-xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <span className="text-4xl font-extrabold text-violet-600">299€</span>
              ...
              <Link href="/tarifs" className="inline-block bg-violet-600 text-white font-bold px-8 py-3 rounded-full hover:bg-violet-700 transition-colors">Ajouter le pack au panier →</Link>
        ...
        <section className="py-12 px-4 bg-gray-900 text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="text-4xl font-extrabold text-violet-400 mb-1">199€ <span className="text-base font-normal text-gray-400">TTC</span></div>
        ...
        <footer className="bg-gray-50 border-t border-gray-200 py-8 px-4">
          <div className="max-w-5xl mx-auto flex flex-wrap justify-between gap-6 text-sm text-gray-500">
            ...
            <div className="text-xs text-gray-400">
              <a href="mailto:contact@certifdrone.fr" className="hover:text-violet-600">contact@certifdrone.fr</a>
